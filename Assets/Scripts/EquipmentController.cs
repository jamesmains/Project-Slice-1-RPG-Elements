...
public class EquipmentController : MonoBehaviour {
    ...
    private void OnEnable() {
        Player.OnPlayerCreated += RegisterPlayerCallbacks;
    ...
    private void OnDisable() {
        ...
        if (AssociatedPlayer != null) {
            Player.Singleton.OnPlayerStatsChanged -= SetBreakdownText;
        }
    }
    ...
    private void SetPlayerEquipment(Item[] items) {
        ...
        Player.Singleton.OnItemAdded.Invoke(itemsToEquip);
    }
    ...
    private void SetBreakdownText() {
        ...
        var playerStats = Player.Singleton.PlayerEntity.GetBaseStats();
